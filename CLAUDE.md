...
2. **Procesador de notas** — Una carpeta `rufino/` donde el usuario tira notas crudas. Un cron job diario las procesa: las categoriza, analiza, enriquece con contexto, y las organiza automáticamente.
